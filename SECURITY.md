...
- **Preferred:** open a private report via
  [GitHub Security Advisories](https://github.com/sergebulaev/tiktok-skills/security/advisories/new)
- **Alternative:** email `s@bulaev.org` with subject `[SECURITY] tiktok-skills`
...
- Please do not test vulnerabilities against third-party services
  (TikTok, Apify, Publora) outside their own disclosure programs.
